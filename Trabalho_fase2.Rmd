...
# Combine as colunas categóricas codificadas com as numéricas
...
model_nb <- naivebayes::naive_bayes(DFS_STATUS ~ ., data = trainData)
nb_pred <- predict(model_nb, newdata = testData)
